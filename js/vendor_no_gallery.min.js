...
_Blog.changeTitle=function(){var currentTitle=document.title;window.onblur=function(){document.title='打工笔记';}
...
$('.theme-switch').on('click',()=>{const iframe=document.querySelector('.utterances-frame');$('body').toggleClass('dark-theme')
window.localStorage&&window.localStorage.setItem('theme',document.body.classList.contains('dark-theme')?'dark':'light',)
const dark_message={type:'set-theme',theme:'github-dark'};const light_message={type:'set-theme',theme:'github-light'};if(document.body.classList.contains('dark-theme')){iframe.contentWindow.postMessage(dark_message,'https://utteranc.es');}else{iframe.contentWindow.postMessage(light_message,'https://utteranc.es');}})}
